...
for k, v in action_timeline.items():
    ax_gantt.broken_barh(v, (i-0.4,0.8), color=color[k])
    i += 1
...
plt.tight_layout()       
plt.savefig("../data/output/v2/results/CU36_CU110/20180910_033055_154_2_actions_gantt.png")
plt.show()
...
plt.tight_layout()
plt.savefig("../data/output/v2/results/CU36_CU110/20180910_033055_154_2_actions_hist.png")
